...
//  Carrito
const CarritosDAOFactory = require("../persistencia/DAOs/Factory.class/CarritoDAOFactory.class")
const DAOcart = CarritosDAOFactory.get()

// Producto
const ProductosDAOFactory = require("../persistencia/DAOs/Factory.class/ProductoDAOFactory.class")
const DAOprod = ProductosDAOFactory.get()

// usuario
const UsuariosDAOFactory = require("../persistencia/DAOs/Factory.class/UsuarioDAOFactory.class")
